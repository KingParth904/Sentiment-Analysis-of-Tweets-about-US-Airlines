...
st.markdown("This application is a Streamlit Dashboard for Sentiment Analysis of Tweets 💀")
st.sidebar.markdown("Choose it Correctly 💀")

data_url=("C:/Users/sanja/OneDrive/Desktop/CLass\Streamlit/Tweets.csv")
...
hour = st.sidebar.slider("Hour of data",0,23)       
...
choice= st.sidebar.multiselect('Pick airlines', ('US Airways','American','Southwest','Delta','Virgin America'),key='0')        
